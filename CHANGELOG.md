...
- Ensure ddtrace is disabled for test suite.
- Fixes a number of unit test warnings.
...
- For guild wars, create the Convoke game before being fully seated.

## [v21.10.0](https://github.com/lexicalunit/spellbot/releases/tag/v21.10.0) - 2026-09-10
...
- Updated configuration for database connection pool.
- Better thresholds for RDS monitors.

## [v21.9.1](https://github.com/lexicalunit/spellbot/releases/tag/v21.9.1) - 2026-08-30
...
- Don't trigger PD alert for "unknown channel" errors.

## [v21.6.1](https://github.com/lexicalunit/spellbot/releases/tag/v21.6.1) - 2026-07-27

### Fixed

- Fix FK issue when a user logs into SpellBot without ever having used the bot before.

## [v21.6.0](https://github.com/lexicalunit/spellbot/releases/tag/v21.6.0) - 2026-07-19

### Added

- Disability pride month logo.

## [v21.5.0](https://github.com/lexicalunit/spellbot/releases/tag/v21.5.0) - 2026-07-15

### Added

- Added tests for i18n configuration files.

### Changed

- More unified style across the website.

### Fixed

- Fixed logout for admin users.

## [v21.4.1](https://github.com/lexicalunit/spellbot/releases/tag/v21.4.1) - 2026-07-14

### Changed

- Changed the Convoke API timeout to 3 seconds.
...
- Remove some noisy logging in data export code.

## [v21.2.0](https://github.com/lexicalunit/spellbot/releases/tag/v21.2.0) - 2026-06-14

### Added

- Added i18n for web pages.

### Fixed

- Fix links vs buttons in records pages.

## [v21.1.0](https://github.com/lexicalunit/spellbot/releases/tag/v21.1.0) - 2026-06-14

### Changed

- Dedicated awards management page.
- Unified login.
- CSS tweaks for readability.

## [v21.0.5](https://github.com/lexicalunit/spellbot/releases/tag/v21.0.5) - 2026-06-13

### Fixed

- Fixes a possible race condition in /lfg and Join button handling.
...
## [v21.0.3](https://github.com/lexicalunit/spellbot/releases/tag/v21.0.3) - 2026-06-13

### Changed

- Clean up styles and templates.

## [v21.0.2](https://github.com/lexicalunit/spellbot/releases/tag/v21.0.2) - 2026-06-13

### Changed

- Unified style across various records and active queues pages.

## [v21.0.1](https://github.com/lexicalunit/spellbot/releases/tag/v21.0.1) - 2026-06-12

### Added

- More links in the headers of the website for easier navigation.

## [v21.0.0](https://github.com/lexicalunit/spellbot/releases/tag/v21.0.0) - 2026-06-12

### Changed

- Removed a number of commands in favor of using the website to manage settings and view records.

## [v20.13.1](https://github.com/lexicalunit/spellbot/releases/tag/v20.13.1) - 2026-06-11

### Fixed

- Fix server/channel settings viewer permissions when viewer is owner.

## [v20.13.0](https://github.com/lexicalunit/spellbot/releases/tag/v20.13.0) - 2026-06-11
...
- Adds a Tournament Organizer mode for channels.
- Audit trail for guild and channel settings changes.
...
- Fixed CSS for visited links.
- Added controls for toggling promotion on guilds.
...
## [v20.10.0](https://github.com/lexicalunit/spellbot/releases/tag/v20.10.0) - 2026-06-09

### Added

- Added a `make dev` command for easier local development.
- A CTA for notification support so people can discover this feature more easily.
...
## [v20.9.0](https://github.com/lexicalunit/spellbot/releases/tag/v20.9.0) - 2026-05-31
...
- Allow users to turn off notifications for a server.
- Show if a server has notifications turned on or off in the queues page.

## [v20.7.5](https://github.com/lexicalunit/spellbot/releases/tag/v20.7.5) - 2026-05-30

### Changed

- Even more adjustment to the queues page styles.

## [v20.7.4](https://github.com/lexicalunit/spellbot/releases/tag/v20.7.4) - 2026-05-30

### Changed

- Adjust queues size a bit so server names fit better.

## [v20.7.3](https://github.com/lexicalunit/spellbot/releases/tag/v20.7.3) - 2026-05-30

### Fixed

- Fix security issues with redirect.

## [v20.7.2](https://github.com/lexicalunit/spellbot/releases/tag/v20.7.2) - 2026-05-30

### Fixed

- Fix the color of the notifications bell icon when visited.

## [v20.7.1](https://github.com/lexicalunit/spellbot/releases/tag/v20.7.1) - 2026-05-30

### Changed

- Changed vanity domains to redirects.
- Added "Setup notification" button to cards in the queues page.
...
- Improve SQL query performance for channel records.

## [v20.6.0](https://github.com/lexicalunit/spellbot/releases/tag/v20.6.0) - 2026-05-27
...
- Sorting and filter to records pages.
...
- Active queues filtering.

## [v20.3.0](https://github.com/lexicalunit/spellbot/releases/tag/v20.3.0) - 2026-05-26

### Added

- Adds an active queues page.

### Changed

- Updated translations.

## [v20.2.0](https://github.com/lexicalunit/spellbot/releases/tag/v20.2.0) - 2026-05-26

### Added

- Translations for Finnish, Italian, and Tagalog.

### Changed

- Change the sort order for queue activity in dashboard.

## [v20.1.0](https://github.com/lexicalunit/spellbot/releases/tag/v20.1.0) - 2026-05-25

### Added

- Adds more queue depth details to the dashboard.

### Changed

- Reduce twitchiness of the database latency monitor.

## [v20.0.1](https://github.com/lexicalunit/spellbot/releases/tag/v20.0.1) - 2026-05-25

### Added

- Adds some unit testing of JS code.

### Changed

- Adjust styles on user records so word wrapping looks better.

## [v20.0.0](https://github.com/lexicalunit/spellbot/releases/tag/v20.0.0) - 2026-05-25
...
- Updated CI/CD workflow so that the ci step depends on the deploy step.

## [v19.1.9](https://github.com/lexicalunit/spellbot/releases/tag/v19.1.9) - 2026-05-23

### Added

- Added locale tracker per guild.

## [v19.1.8](https://github.com/lexicalunit/spellbot/releases/tag/v19.1.8) - 2026-05-23
...
- Adds an `active` column to guilds to filter them out of tasks.

## [v19.1.5](https://github.com/lexicalunit/spellbot/releases/tag/v19.1.5) - 2026-05-22

### Added

- Added playgroup live text to i18n system.
- Use user's locale for ephemeral message translations.

## [v19.1.4](https://github.com/lexicalunit/spellbot/releases/tag/v19.1.4) - 2026-05-22
...
## [v19.1.2](https://github.com/lexicalunit/spellbot/releases/tag/v19.1.2) - 2026-05-22

### Added

- Log pipeline processor to categorize ECS tasks by container.
- Additional logging for admin dashboard authentication.
- Trace configuration to avoid traces with resource_name being empty.

## [v19.1.1](https://github.com/lexicalunit/spellbot/releases/tag/v19.1.1) - 2026-05-21

### Fixed

- Fixes a bug in the deployment script due to stage/prod deployments.

## [v19.1.0](https://github.com/lexicalunit/spellbot/releases/tag/v19.1.0) - 2026-05-21

### Added

- Adds a Admin Dashboard for system wide analytics and management.

## [v19.0.3](https://github.com/lexicalunit/spellbot/releases/tag/v19.0.3) - 2026-05-21
...
## [v19.0.2](https://github.com/lexicalunit/spellbot/releases/tag/v19.0.2) - 2026-05-21

### Fixed

- Fixed a number of typos and documentation issues.

## [v19.0.1](https://github.com/lexicalunit/spellbot/releases/tag/v19.0.1) - 2026-05-21

### Changed

- Security headers for the website.
- Updated dependencies.
- Refactor branding configuration.
- Increased test coverage.
- More DB related o11y alerts and dashboard improvements.

## [v19.0.0](https://github.com/lexicalunit/spellbot/releases/tag/v19.0.0) - 2026-05-20
...
- Adds a "Unique Players per Channel" chart to the analytics page.
...
- Better factored web API code.

## [v18.9.1](https://github.com/lexicalunit/spellbot/releases/tag/v18.9.1) - 2026-05-13

### Fixed

- Fix the italic message formatting for Playgroup Live LFG embed.

## [v18.9.0](https://github.com/lexicalunit/spellbot/releases/tag/v18.9.0) - 2026-05-13

### Added

- A link to the version history from the status page.
- Support for Playgroup Live!
...
- More DRY operations code.

## [v18.8.0](https://github.com/lexicalunit/spellbot/releases/tag/v18.8.0) - 2026-05-12

### Changed

- Updated dependencies and general maintenance.
- Refactor to use async database sessions.

## [v18.7.2](https://github.com/lexicalunit/spellbot/releases/tag/v18.7.2) - 2026-05-12
...
- Moved `jump_link()` into `PostData`.

## [v18.6.0](https://github.com/lexicalunit/spellbot/releases/tag/v18.6.0) - 2026-05-08

### Changed

- Moved images to the website, rather than using GitHub Issues as a CDN.

### Added

- Added a JSON status page.
- Added a docs Makefile for easier local development.

## [v18.5.0](https://github.com/lexicalunit/spellbot/releases/tag/v18.5.0) - 2026-05-08
...
## [v18.4.10](https://github.com/lexicalunit/spellbot/releases/tag/v18.4.10) - 2026-04-22

### Changed

- Ignore ALREADY_ACKNOWLEDGED_CODE error spans.

## [v18.4.9](https://github.com/lexicalunit/spellbot/releases/tag/v18.4.9) - 2026-04-22
...
- Handle trace errors in the operations retry() function too.

## [v18.4.6](https://github.com/lexicalunit/spellbot/releases/tag/v18.4.6) - 2026-04-20

### Changed

- Don't treat 404 on defer interaction or 403 on delete message as errors in traces.

## [v18.4.5](https://github.com/lexicalunit/spellbot/releases/tag/v18.4.5) - 2026-04-20

### Fixed

- Reverting the caching changes for now.

## [v18.4.4](https://github.com/lexicalunit/spellbot/releases/tag/v18.4.4) - 2026-04-20

### Changed

- Less noisy datadog monitors.
- Updated dependencies.
- Stronger caching for guilds and channels.

## [v18.4.3](https://github.com/lexicalunit/spellbot/releases/tag/v18.4.3) - 2026-04-20
...
## [v18.4.1](https://github.com/lexicalunit/spellbot/releases/tag/v18.4.1) - 2026-04-08

### Fixed

- Fix handing of "PRECON" enum for Convoke API.

## [v18.4.0](https://github.com/lexicalunit/spellbot/releases/tag/v18.4.0) - 2026-04-08
...
- Slightly more strict check for guild membership.

## [v18.3.1](https://github.com/lexicalunit/spellbot/releases/tag/v18.3.1) - 2026-04-02
...
- Updated dependencies.
- Cleaning up .env.example, DOCKER.md, and adding a docker-compose.yml.

## [v18.2.16](https://github.com/lexicalunit/spellbot/releases/tag/v18.2.16) - 2026-03-15
...
- Improved the analytics page to include more data and be more responsive.

## [v18.2.14](https://github.com/lexicalunit/spellbot/releases/tag/v18.2.14) - 2026-03-14
...
## [v18.2.12](https://github.com/lexicalunit/spellbot/releases/tag/v18.2.12) - 2026-03-03

### Changed

- Updated dependencies.

## [v18.2.11](https://github.com/lexicalunit/spellbot/releases/tag/v18.2.11) - 2026-03-02
...
## [v18.2.9](https://github.com/lexicalunit/spellbot/releases/tag/v18.2.9) - 2026-02-26
...
- Only trace interesting on_message events.

## [v18.2.7](https://github.com/lexicalunit/spellbot/releases/tag/v18.2.7) - 2026-02-26

### Changed

- Improve datadog metrics by unifying span naming and adding more context.
...
## [v18.2.5](https://github.com/lexicalunit/spellbot/releases/tag/v18.2.5) - 2026-02-23

### Fixed

- Fixed analytics page responsiveness.

### Added

- Added a demo analytics page to the repo.

## [v18.2.4](https://github.com/lexicalunit/spellbot/releases/tag/v18.2.4) - 2026-02-21

### Fixed

- Fixes memory leaks in redis related code.

### Removed

- Removes the "bad user" feature.

## [v18.2.3](https://github.com/lexicalunit/spellbot/releases/tag/v18.2.3) - 2026-02-19

### Fixed

- Fixed bot owner override str vs int comparison.

## [v18.2.2](https://github.com/lexicalunit/spellbot/releases/tag/v18.2.2) - 2026-02-19

### Changed

- Bot owner override to allow for debugging in production.

## [v18.2.1](https://github.com/lexicalunit/spellbot/releases/tag/v18.2.1) - 2026-02-19
...
- Adds an /analytics command for server admins.

## [v18.1.0](https://github.com/lexicalunit/spellbot/releases/tag/v18.1.0) - 2026-02-14

### Added

- Adds a SpellTable option, but this works like other game services that require players to create the game themselves.

## [v18.0.0](https://github.com/lexicalunit/spellbot/releases/tag/v18.0.0) - 2026-02-12
...
- Updates gunicorn workers to 4 for prod and 1 for other environments.

## [v17.10.1](https://github.com/lexicalunit/spellbot/releases/tag/v17.10.1) - 2026-01-25
...
- Updated spellbot.png.

## [v17.9.0](https://github.com/lexicalunit/spellbot/releases/tag/v17.9.0) - 2026-01-21
...
- Fixes bracket support for Convoke created games.
...
- Change how patreon and shard status tasks are run, so they start faster.

## [v17.7.7](https://github.com/lexicalunit/spellbot/releases/tag/v17.7.7) - 2026-01-16
...
- Fixed an issue with Patreon integration.

## [v17.7.5](https://github.com/lexicalunit/spellbot/releases/tag/v17.7.5) - 2026-01-15

### Changed

- Made Convoke the default game service. This won't affect any current settings.

## [v17.7.4](https://github.com/lexicalunit/spellbot/releases/tag/v17.7.4) - 2026-01-15

### Changed

- Improved shard health check to be more accurate.

## [v17.7.3](https://github.com/lexicalunit/spellbot/releases/tag/v17.7.3) - 2026-01-15

### Changed

- Shard status task now starts immediately on cog load.

## [v17.7.2](https://github.com/lexicalunit/spellbot/releases/tag/v17.7.2) - 2026-01-15

### Added

- Version info and link to bsky to status page.

## [v17.7.1](https://github.com/lexicalunit/spellbot/releases/tag/v17.7.1) - 2026-01-14

### Fixed

- Fixed issues with supporter emojis not always showing up.

## [v17.7.0](https://github.com/lexicalunit/spellbot/releases/tag/v17.7.0) - 2026-01-13

### Added

- Added link to status page from main page and README.md.
- Special emojis for bot owner and supporters in game embeds.

## [v17.6.3](https://github.com/lexicalunit/spellbot/releases/tag/v17.6.3) - 2026-01-12

### Fixed

- Fixed a bug in one of the unit tests.

## [v17.6.2](https://github.com/lexicalunit/spellbot/releases/tag/v17.6.2) - 2026-01-12
...
- Added a status page at https://spellbot.io/status.

## [v17.5.0](https://github.com/lexicalunit/spellbot/releases/tag/v17.5.0) - 2026-01-07
...
- Expire inactive notifications after 45 minutes.
- Added support for Girudo as a game service!

## [v17.4.0](https://github.com/lexicalunit/spellbot/releases/tag/v17.4.0) - 2026-01-06

### Added

- Added the `DELETE /api/notification/:id` API to delete notifications.

## [v17.3.0](https://github.com/lexicalunit/spellbot/releases/tag/v17.3.0) - 2025-12-28
...
## [v17.2.5](https://github.com/lexicalunit/spellbot/releases/tag/v17.2.5) - 2025-12-16

### Added

- Added Convoke icons and thumbnails for Convoke.

## [v17.2.4](https://github.com/lexicalunit/spellbot/releases/tag/v17.2.4) - 2025-12-12

### Added

- Added documentation about token scopes to API documentation.
...
- Adds scopes to API tokens.

## [v17.2.2](https://github.com/lexicalunit/spellbot/releases/tag/v17.2.2) - 2025-12-06

### Added

- Adds notes to the tokens table for my reference.

## [v17.2.1](https://github.com/lexicalunit/spellbot/releases/tag/v17.2.1) - 2025-12-06

### Added

- Supports updating external notifications.

## [v17.2.0](https://github.com/lexicalunit/spellbot/releases/tag/v17.2.0) - 2025-12-05

### Added

- Supports generating notifications in Discord from games created by external services.

## [v17.1.4](https://github.com/lexicalunit/spellbot/releases/tag/v17.1.4) - 2025-11-19

### Changed

- Allow mentions in "extra" notes.

## [v17.1.3](https://github.com/lexicalunit/spellbot/releases/tag/v17.1.3) - 2025-11-18
