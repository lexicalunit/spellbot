...
@sync_to_async
def upsert(guild: discord.Guild) -> GuildData | None:
...
@sync_to_async
def set_banned(guild_xid: int, banned: bool) -> None:
...
@sync_to_async
def get(guild_xid: int) -> GuildData | None:
...
@sync_to_async
def set_suggest_vc_category(guild_data: GuildData, category: str | None) -> GuildData:
...
@sync_to_async
def set_motd(guild_data: GuildData, message: str | None = None) -> GuildData:
...
@sync_to_async
def toggle_show_links(guild_data: GuildData) -> GuildData:
...
@sync_to_async
def toggle_voice_create(guild_data: GuildData) -> GuildData:
...
@sync_to_async
def toggle_use_max_bitrate(guild_data: GuildData) -> GuildData:
...
@sync_to_async
def voice_category_prefixes(guild_xid: int) -> list[str]:
...
@sync_to_async
def has_award_with_count(guild_xid: int, count: int) -> bool:
...
@sync_to_async
def award_delete(guild_award_id: int) -> None:
...
@sync_to_async
def setup_mythic_track(guild_data: GuildData) -> GuildData:
