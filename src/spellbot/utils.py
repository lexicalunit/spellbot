...
# Discord API error code indicating that the channel no longer exists.
# This can happen when the channel was deleted before we could fetch it.
UNKNOWN_CHANNEL_CODE = 10003
